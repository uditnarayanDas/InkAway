...
import { Upload, Zap, FileText, CheckCircle, ArrowRight, Menu, X } from 'lucide-react';
            ...
            >
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow = '0 10px 25px rgba(168, 85, 247, 0.3)';
                }}
                onMouseLeave={(e) => {
            ...
            >
              ...
              <div 
                style={{
                  ...
                  borderRadius: '50px',
                  padding: '8px 16px',
                  alignSelf: window.innerWidth >= 1024 ? 'flex-start' : 'center'
                }}
              >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <h1 
                  style={{
                    fontSize: window.innerWidth >= 1024 ? '4rem' : window.innerWidth >= 640 ? '3rem' : '2.5rem',
                    fontWeight: 'bold',
                    color: 'white',
                    lineHeight: '1.1',
                    margin: 0
                ...
                >
                  Upload any photo or PDF with unwanted signatures, pen marks, or handwritten text. 
                  Our AI removes them in seconds with pixel-perfect precision.
                </p>
              </div>
              ...
              >
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'white' }}>50K+</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>Documents</div>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'white' }}>99.9%</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>Accuracy</div>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '24px', fontWeight: 'bold', color: 'white' }}>2s</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>Processing</div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <p style={{ color: 'white', fontWeight: '500', fontSize: '16px', margin: '0 0 4px 0' }}>
                      Drop your file here
                    </p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', opacity: 0.5 }}>
                    ...
                    >
                      <CheckCircle size={20} style={{ color: 'rgba(255, 255, 255, 0.5)' }} />
                    </div>
